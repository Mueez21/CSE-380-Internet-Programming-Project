...
http.route({
  ...
  handler: httpAction(async (ctx, request) => {
    ...
    console.log("✅ Received request from Vapi");
    const payload = await request.json();
    console.log("📦 Payload from Vapi:", payload);
    console.log("🔍 user_id received:", payload.user_id);
...
http.route({
  ...
  handler: httpAction(async (ctx, request) => {
    try {
      ...
      console.log("💬 Raw Gemini workout text:", workoutPlanText);
      ...
      try {
        ...
        console.error("❌ Error in workoutPlan:", err, workoutPlanText);
        return new Response(
      ...
      console.log("💬 Raw Gemini diet text:", dietPlanText);
      ...
      try {
        ...
        console.error("❌ Error in dietPlan:", err, dietPlanText);
        return new Response(
