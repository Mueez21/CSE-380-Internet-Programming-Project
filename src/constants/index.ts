...
// If you're using Next.js (or any framework where images in 'public/' are served statically),
// place your custom images in public/assets/ (or directly in public/) and reference via URL strings.

export const USER_PROGRAMS = [
  {
    id: 1,
    first_name: "Mueez",
    // Replace with your public path (no import needed)
    profilePic: "/assets/mueez.jpg",
  ...
  {
    id: 2,
    first_name: "Bonoshree",
    profilePic: "/assets/BT.jpg",
    ...
    workout_plan: {
      ...
      description:
        "This program implements a traditional body-part split with emphasis on progressive overload. Each muscle group is trained with moderate volume and adequate recovery to maximize weight gain.",
    },
    diet_plan: {
      ...
      description:
        "This high-protein, calorie-surplus diet supports weight gain. Carbohydrates are timed around workouts for optimal performance and recovery.",
    },
  },
  {
    id: 3,
    first_name: "Mahtab",
    profilePic: "/assets/angkon.jpg",
